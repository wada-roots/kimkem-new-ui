const WhatsAppFloat = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-[60] bg-[#25D366] hover:bg-[#20b954] text-white p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 border-2 border-white"
